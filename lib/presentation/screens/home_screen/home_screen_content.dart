...
import 'package:glasses_store_design/presentation/screens/details_screen/details_screen_view.dart';
      ...
      children: [
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(colors:[Colors.cyanAccent.shade100,Colors.grey.shade200],begin: Alignment.topLeft,end: Alignment.bottomRight),
          ),
        ),
        SafeArea(
          child: ListView(
                  ...
                  itemBuilder: (context, index) => GestureDetector(
                    onTap: () {
                      Navigator.push(context,
                          CupertinoDialogRoute(builder: (context) =>  DetailsScreenView(index: index,), context: context),);
                    },
                    child: Stack(
                      children: [
                        Container(
                        ...
                        Positioned(
                          ...
                          child: Align(
                            alignment: Alignment.topRight,
                              child: IconButton(onPressed: () {},icon:Icon(Icons.favorite_border,color: Colors.black,size: 25.px,),)),
                        )
                      ],
